...
INSERT INTO rentye.apartment (id, acceptance_to_use_date, acquisition_date, city, country, date_sold, description,
                              flat_number, house_number, land_mortgage_register_number, name, notarial_act_number,
                              status, street, usable_area, zip, depreciation_id)
VALUES (1, null, null, null, null, null, 'Appt 1 desc', null, null, null, 'Appt 1', null, null, null, null, null, null);

INSERT INTO rentye.apartment (id, acceptance_to_use_date, acquisition_date, city, country, date_sold, description,
                              flat_number, house_number, land_mortgage_register_number, name, notarial_act_number,
                              status, street, usable_area, zip, depreciation_id)
VALUES (2, null, null, null, null, null, 'Appt 2 desc', null, null, null, 'Appt 2', null, null, null, null, null, null);
...
INSERT INTO rentye.transaction_party (id, city, country, email, first_name, flat_number, full_name, house_number,
