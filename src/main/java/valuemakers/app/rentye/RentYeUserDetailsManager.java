...
public class RentYeUserDetailsManager implements UserDetailsManager {
    ...
    public RentYeUserDetailsManager(UserAccountRepository userAccountRepository) {
        this.userAccountRepository = userAccountRepository;
    }

    @Override
    public void createUser(UserDetails user) {
        userAccountRepository.save(((RentYeUserDetails) user).getUserAccount());
    }
    ...
    public RentYeUserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        if (userAccount != null)
            return new RentYeUserDetails(userAccount);
        else
            throw new UsernameNotFoundException("User not found");
    }
